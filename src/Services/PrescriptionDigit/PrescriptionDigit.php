...
namespace App\Services\PrescriptionDigit;


use Symfony\Component\HttpKernel\KernelInterface;

class PrescriptionDigit
{
    private $kernel;
    ...
    private function decline($group = 0, $digit = 0.0): string
    {
        ...
        $text = (int)$text[strlen((string)$digit) - 1];
        $result = '';
    ...
    private function getLangFile(string $lang = 'ru'): string
    {
        return sprintf(sprintf('%s/translations/prescription/%s.php', $this->kernel->getProjectDir(), $lang ?: $this->lang));
    }
}