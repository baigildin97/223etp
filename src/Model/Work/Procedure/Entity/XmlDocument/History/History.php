...
/**
 * Class History
 * @package App\Model\Work\Procedure\Entity\XmlDocument\History
 * @ORM\Entity()
 * @ORM\Table(name="procedure_xml_document_history")
 */
class History
{
    /**
    ...
    /**
     * @var XmlDocument
     * @ORM\ManyToOne(targetEntity="App\Model\Work\Procedure\Entity\XmlDocument\XmlDocument", inversedBy="history")
