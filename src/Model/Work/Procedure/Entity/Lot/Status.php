...
class Status
{
    ...
    public const STATUS_ARCHIVE = 'STATUS_ARCHIVED';
    ...
    public function isApplicationsReceived(): bool{
        return $this->name === self::STATUS_APPLICATIONS_RECEIVED;
    }
    ...
    public function isArchive(): bool {
        return $this->name === self::STATUS_ARCHIVE;
    }
    ...
    public function isStatusSignedProtocolResult(): bool {
        return $this->name === self::STATUS_SIGNED_PROTOCOL_RESULT;
    }
