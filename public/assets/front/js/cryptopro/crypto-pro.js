	    ...
	    return new Promise(function (resolve, reject) {
	        eval(cryptoCommon.generateAsyncFn(function getSystemInfo() {
	            ...
	            try {
	                ...
	                sysInfo.cspName = 'yield' + e.CSPName();
	                ...
	                sysInfo.cspName = 'yield' + sysInfo.cspName.toString();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function prepareCertsInfo(items) {
	    return items.map(function (c) {
	        ...
	        c.nameIssuer = c.issuerName.match(/CN=(.+?)(?:,|$)/);
			c.position = c.subjectName.match(/T=(.+?)(?:,|$)/);
			...
			if (c.nameIssuer && c.nameIssuer[1]){
				c.nameIssuer = c.nameIssuer[1];
			}
			if (c.position && c.position[1]){
